...
- 앱에서 내보내거나 가져올 수있는 모든 파일 형식에 대해 내보내고 가져온 UTI를 추가합니다. 일반적으로 앱에 고유 한 문서 유형과 달리 UTI는 일반 텍스트 또는 그림 의 일반 형식을 지정합니다 `.png`. 예를 들어 UTI는 응용 프로그램간에 클립 보드로 복사 및 붙여 넣기를 지원합니다.
...
--------
## <a name="sboverview"></a>StoryBoard OverView *<small><update 20.06.05><small>*
...
SafeArea는 전체 인터페이스의 보이는 부분 내에 뷰를 배치하는 데 도움을 줍니다. <br>
SafeArea는 콘텐츠가 상태바, 내비게이션바, 툴바, 탭바를 가리는 것을 방지하는 영역입니다. 표준 시스템이 제공하는 뷰들은 자동으로 안전 영역 레이아웃 가이드를 준수하게 되어있습니다.
<br>
...
![이미지 : ../Art/segue_defined_2x.png](https://developer.apple.com/library/archive/featuredarticles/ViewControllerPGforiPhoneOS/Art/segue_defined_2x.png)<br>
...
-------
## <a name="autolayout"></a>AutoLayout *<small><update 20.06.06><small>*

**AutoLayout**

AutoLayout은 뷰의 제약 사항을 바탕으로 뷰 체계 내의 모든 뷰의 크기와 위치를 동적으로 계산합니다.

AutoLayout은 애플리케이션을 사용할 때 발생하는 외부 변경과 내부 변경에 동적으로 반응하는 사용자 인터페이스를 가능하게 합니다.
...
AutoLayout은 아래의 경우와 같이 인터페이스의 절대적인 좌표가 아닌 동적으로 상대적인 좌표가 필요한 경우에 유용합니다.
...
AutoLayout의 속성은 정렬 사각형을 기반으로 합니다.

[![](https://cphinf.pstatic.net/mooc/20180131_23/1517382343431DS66c_PNG/99_0.png?type=w760)](https://www.edwith.org/boostcourse-ios/lecture/16848/#)
...
[![](https://cphinf.pstatic.net/mooc/20180131_279/1517382425613u4b3S_PNG/99_1.png?type=w760)](https://www.edwith.org/boostcourse-ios/lecture/16848/#)
...
[![](https://cphinf.pstatic.net/mooc/20180131_215/1517382467433FzU1i_PNG/99_2.png?type=w760)](https://www.edwith.org/boostcourse-ios/lecture/16848/#)
...
AutoLayout은 뷰의 고유 콘텐츠 크기를 각 크기에 대한 한 쌍의 제약을 사용하여 나타냅니다. 우선도가 높을수록 다른 제약보다 우선적으로 레이아웃에 적용하며, 같은 속성의 다른 제약과 경합하는 경우, 우선도가 낮은 제약은 무시됩니다.
...
[![](https://cphinf.pstatic.net/mooc/20180131_230/15173826015792mxXH_PNG/99_8.png?type=w760)](https://www.edwith.org/boostcourse-ios/lecture/16848/#)
...
[![](https://cphinf.pstatic.net/mooc/20180131_206/1517382710033CnwVl_PNG/99_3.png?type=w760)](https://www.edwith.org/boostcourse-ios/lecture/16848/#)

1. 객체 라이브러리에서 버튼과 레이블을 추가해줍니다. 이제 앵커를 활용하여 제약을 만들어봅시다.

[![](https://cphinf.pstatic.net/mooc/20180131_226/1517382742277GMVQP_PNG/99_4.png?type=w760)](https://www.edwith.org/boostcourse-ios/lecture/16848/#)

2. @IBOutlet을 활용하여 인터페이스 빌더에서 ViewController.swift 파일로 버튼과 레이블을 연결해줍니다.

[![](https://cphinf.pstatic.net/mooc/20180131_211/1517382774420xuP4X_PNG/99_5.png?type=w760)](https://www.edwith.org/boostcourse-ios/lecture/16848/#)
...
[![](https://cphinf.pstatic.net/mooc/20180131_133/1517382840563Nszvr_PNG/99_6.png?type=w760)](https://www.edwith.org/boostcourse-ios/lecture/16848/#)
...
[![](https://cphinf.pstatic.net/mooc/20180131_159/15173828740722wpPp_PNG/99_7.png?type=w760)](https://www.edwith.org/boostcourse-ios/lecture/16848/#)
